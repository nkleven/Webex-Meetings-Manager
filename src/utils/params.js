...
const scopes = 'meeting:admin_preferences_write meeting:admin_schedule_write meeting:admin_preferences_read meeting:admin_schedule_read spark:kms spark-admin:people_read';
